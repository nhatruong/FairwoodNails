...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
            ...
            $(":radio").on("click", function () {
                ...
                $("div[title='service']").each(function () {
                    if ($(this).attr("class") == val) {
                        $(this).show();
                        //set background image to each class
    ...
    <div class="row">                    
            <div class="col-md-3 col-sm-4"><asp:RadioButton ID="nail" GroupName="services" runat="server" Text="Menicure" /></div>
            ...
            <div class="col-md-6 col-sm-4"><asp:RadioButton ID="additional" GroupName="Services" runat="server" Text="Additional Services" /></div>       
    </div>
    <hr />
    ...
    <div class="row">
        ...
        <div id="eyelashextensionservice" title="service" class="eyelash">
            <div class="col-md-6 col-sm-12">
